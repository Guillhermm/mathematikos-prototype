...
const SplashScreen: React.FC<SplashScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div className="splash-screen" onClick={onComplete}>
      ...
      <RomanSymbol
        value={2024}
        className="splash-svg symbol"
        classNameContainer="splash-svg-left-bottom"
      />
      <BabylonianSymbol
        value={2013}
        className="splash-svg symbol"
        classNameContainer="splash-svg-left-top "
      />
      <EgyptianSymbol
        value={1111111}
        className="splash-svg symbol-medium"
        classNameContainer="splash-svg-right-top"
      />
      <GreekSymbol
        value={2018}
        className="splash-svg symbol-large"
        classNameContainer="splash-svg-right-bottom"
      />
    </div>
  );
};
